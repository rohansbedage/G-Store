...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="300" > 
</div>
</div>
...
<label class="control-label" for="basicinput"><h1>New Product For Image : Image 3</h1></label>
