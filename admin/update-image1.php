...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="300" > 
</div>
</div>
...
<label class="control-label" for="basicinput"><h1>New Product For Image : Image 1</h1></label>
